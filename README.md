# Sistem Automatic Notification Dalam Konteks Manajemen Perkantoran
...
<ul>
  <li>Master untuk server dari model notifikais</li>
  <li>Client untuk simulasi aplikasi tata surat berbasis website</li>
</ul>
